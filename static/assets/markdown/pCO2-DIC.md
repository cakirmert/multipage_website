...
It is a key variable of the carbonate system and directly linked to pH, alkalinity, and gas exchange with atmospheric CO$_2$.
...
- The system contains only CO$_2$(aq), HCO$_3^-$, CO$_3^{2-}$, H$^+$, and OH$^-$  
